...
@NamedQueries({
    ...
    @NamedQuery(name = "Cliente.findByIdCliente", query = "SELECT p FROM Cliente p WHERE p.idCliente = :idCliente"),
    ...
    @NamedQuery(name = "Cliente.findByEmail", query = "SELECT p FROM Cliente p WHERE p.email = :email"),
